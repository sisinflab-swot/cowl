...
on allocation errors. Sometimes this may not be enough, such as when parsing ontology documents:
...
:func:`CowlParser::cowl_parser_set_error_handler()`), or you can opt to specify a global
