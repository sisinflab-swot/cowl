 ...
 */
COWL_INLINE
CowlDataPropAssertAxiom* cowl_data_prop_assert_axiom_get(CowlDataPropExp *prop,
                                                         CowlIndividual *subj,
                                                         CowlLiteral *obj,
                                                         CowlVector *annot) {
 ...
 */
COWL_INLINE
CowlDataPropAssertAxiom* cowl_neg_data_prop_assert_axiom_get(CowlDataPropExp *prop,
                                                             CowlIndividual *subj,
                                                             CowlLiteral *obj,
                                                             CowlVector *annot) {
