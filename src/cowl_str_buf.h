...
cowl_ret_t cowl_str_buf_append_sub_obj_prop_chain_axiom(CowlStrBuf *buf, CowlSubObjPropChainAxiom *axiom);
...
cowl_ret_t cowl_str_buf_append_annot_prop_domain_axiom(CowlStrBuf *buf, CowlAnnotPropDomainAxiom *axiom);
cowl_ret_t cowl_str_buf_append_annot_prop_range_axiom(CowlStrBuf *buf, CowlAnnotPropRangeAxiom *axiom);
