...
#define GEN_CASE_RELEASE(CAT, TYPE, PREFIX) \
    ...
    switch (axiom->type) {
        ...
        GEN_CASE_RELEASE(CAT_OBJ_PROP_ASSERTION, CowlObjPropAssertAxiom,
                         cowl_obj_prop_assert_axiom);
        GEN_CASE_RELEASE(CAT_NEGATIVE_OBJ_PROP_ASSERTION, CowlObjPropAssertAxiom,
                         cowl_obj_prop_assert_axiom);
...
#define GEN_CASE_EQUAL(CAT, TYPE, PREFIX) \
    ...
    switch (lhs->type) {
        ...
        GEN_CASE_EQUAL(CAT_NEGATIVE_OBJ_PROP_ASSERTION, CowlObjPropAssertAxiom,
                       cowl_obj_prop_assert_axiom);
...
#define GEN_CASE_SIG(CAT, TYPE, PREFIX) \
    ...
    switch (axiom->type) {
        ...
        GEN_CASE_SIG(CAT_NEGATIVE_OBJ_PROP_ASSERTION, CowlObjPropAssertAxiom,
                     cowl_obj_prop_assert_axiom);
