...
bool cowl_sub_annot_prop_axiom_iterate(CowlSubAnnotPropAxiom *axiom, CowlIterator *iter) {
    if (cowl_annot_prop_iterate(axiom->super_prop, iter) &&
        cowl_annot_prop_iterate(axiom->sub_prop, iter) &&
