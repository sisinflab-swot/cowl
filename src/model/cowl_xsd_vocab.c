...
void cowl_xsd_vocab_init(void) {
    ...
    vocab = (cowl_struct(CowlXSDVocab)) {
        ...
        .iri = v.iri,
        .dt = {
            .any_uri = cowl_datatype_vocab_get(v.iri.any_uri),
            .base64_binary = cowl_datatype_vocab_get(v.iri.base64_binary),
            .boolean = cowl_datatype_vocab_get(v.iri.boolean),
            .byte = cowl_datatype_vocab_get(v.iri.byte),
            .date_time = cowl_datatype_vocab_get(v.iri.date_time),
            .date_timestamp = cowl_datatype_vocab_get(v.iri.date_timestamp),
            .decimal = cowl_datatype_vocab_get(v.iri.decimal),
            .xsd_double = cowl_datatype_vocab_get(v.iri.xsd_double),
            .xsd_float = cowl_datatype_vocab_get(v.iri.xsd_float),
            .hex_binary = cowl_datatype_vocab_get(v.iri.hex_binary),
            .xsd_int = cowl_datatype_vocab_get(v.iri.xsd_int),
            .integer = cowl_datatype_vocab_get(v.iri.integer),
            .language = cowl_datatype_vocab_get(v.iri.language),
            .xsd_long = cowl_datatype_vocab_get(v.iri.xsd_long),
            .name = cowl_datatype_vocab_get(v.iri.name),
            .ncname = cowl_datatype_vocab_get(v.iri.ncname),
            .negative_int = cowl_datatype_vocab_get(v.iri.negative_int),
            .nmtoken = cowl_datatype_vocab_get(v.iri.nmtoken),
            .non_negative_int = cowl_datatype_vocab_get(v.iri.non_negative_int),
            .non_positive_int = cowl_datatype_vocab_get(v.iri.non_positive_int),
            .norm_string = cowl_datatype_vocab_get(v.iri.norm_string),
            .xsd_short = cowl_datatype_vocab_get(v.iri.xsd_short),
            .string = cowl_datatype_vocab_get(v.iri.string),
            .token = cowl_datatype_vocab_get(v.iri.token),
            .unsigned_byte = cowl_datatype_vocab_get(v.iri.unsigned_byte),
            .unsigned_int = cowl_datatype_vocab_get(v.iri.unsigned_int),
            .unsigned_long = cowl_datatype_vocab_get(v.iri.unsigned_long),
            .unsigned_short = cowl_datatype_vocab_get(v.iri.unsigned_short)
        }
    };
}
