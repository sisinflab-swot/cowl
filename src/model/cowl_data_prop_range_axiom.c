...
bool cowl_data_prop_range_axiom_iterate(CowlDataPropRangeAxiom *axiom, CowlIterator *iter) {
    if (cowl_data_prop_exp_iterate(axiom->prop_exp, iter) &&
        cowl_data_range_iterate(axiom->range, iter) &&
