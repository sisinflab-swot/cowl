...
bool cowl_test_ontology_axiom_count_for_class(void) {
    ...
    cowl_uint_t count = cowl_ontology_axiom_count_for_class(cowl_test_ontology_get(), cls);
...
bool cowl_test_ontology_axiom_count_for_datatype(void) {
    ...
    cowl_uint_t count = cowl_ontology_axiom_count_for_datatype(cowl_test_ontology_get(), dt);
...
bool cowl_test_ontology_axiom_count_for_obj_prop(void) {
    ...
    cowl_uint_t count = cowl_ontology_axiom_count_for_obj_prop(cowl_test_ontology_get(), prop);
...
bool cowl_test_ontology_axiom_count_for_data_prop(void) {
    ...
    cowl_uint_t count = cowl_ontology_axiom_count_for_data_prop(cowl_test_ontology_get(), prop);
...
bool cowl_test_ontology_axiom_count_for_annot_prop(void) {
    ...
    cowl_uint_t count = cowl_ontology_axiom_count_for_annot_prop(cowl_test_ontology_get(), prop);
...
bool cowl_test_ontology_axiom_count_for_named_ind(void) {
    ...
    cowl_uint_t count = cowl_ontology_axiom_count_for_named_ind(cowl_test_ontology_get(), ind);
