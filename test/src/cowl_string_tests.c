...
void cowl_test_string_lifecycle(void) {
    CowlString *string = cowl_string_from_literal(COWL_TEST_STRING);
...
void cowl_test_string_equals(void) {
    CowlString *a = cowl_string_from_literal(COWL_TEST_STRING);
    CowlString *b = cowl_string_from_literal(COWL_TEST_STRING);
    cowl_assert_equal(string, a, b);
    cowl_release(b);

    b = cowl_string_from_literal(COWL_TEST_STRING "_2");
...
void cowl_test_string_with_format(void) {
    ...
    CowlString *other = cowl_string_from_literal("Test string 1");
...
void cowl_test_string_concat(void) {
    CowlString *string = cowl_string_from_literal(COWL_TEST_STRING);
    CowlString *other = cowl_string_from_literal(COWL_TEST_STRING);

    CowlString *concat = cowl_string_concat(string, other);
    CowlString *oracle = cowl_string_from_literal(COWL_TEST_STRING COWL_TEST_STRING);
